...
const AboutUs = () => {
  return (
    <div className="max-h-[512px] text-center h-[512px] bg-white w-full">
      <div className="flex flex-col pt-8">
        <h2 className="text-black font-bold text-[32px]">About us</h2>
        <p className="text-[#1E1E1E80]  text-[18px] ">
          Order now and appreciate the beauty of nature.
        </p>
        <div className="flex gap-[24px] justify-center items-center pt-[48px]">
          <div className="flex flex-col items-center">
            <div className="bg-[#C1DCDC] w-[96px] h-[96px] rounded-full flex justify-center items-center">
